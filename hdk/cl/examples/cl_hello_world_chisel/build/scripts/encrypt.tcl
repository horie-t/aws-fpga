...
file copy -force $CL_DIR/design/ClHelloWorld.sv                       $TARGET_DIR 
file copy -force $CL_DIR/design/ResetSyncNeg.sv                       $TARGET_DIR 
file copy -force $CL_DIR/design/TieOffDdrABDBlackBox.sv               $TARGET_DIR 
